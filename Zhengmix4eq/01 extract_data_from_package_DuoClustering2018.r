...
counts_dsn     <-  "C:/scRNA_seq/stable_clusterings/Zhengmix4eq/counts_dgCMatrix.pkl"
cell_data_dsn  <-  "C:/scRNA_seq/stable_clusterings/Zhengmix4eq/cell_data.pkl"
gene_data_dsn  <-  "C:/scRNA_seq/stable_clusterings/Zhengmix4eq/gene_data.pkl"
