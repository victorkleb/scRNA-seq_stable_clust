...
df_clusters = pd.read_pickle ( ground_truth_clusters_dsn ).rename ( columns={'Cluster':'cluster'} )
print ( '\n\n df_clusters: \n', df_clusters, file=logfile )
print ( '\n\n len (df_clusters): \n', len ( df_clusters ), file=logfile )

ser_clusters_vc = df_clusters['cluster'].value_counts()
...
###### first of 2 names for index in output table_Tex
latex_list[3] = 'cell' + latex_list[3]
