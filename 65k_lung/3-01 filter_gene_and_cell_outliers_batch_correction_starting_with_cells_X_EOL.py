...
####################################################################################### 
#                                                                                     #
#     filter_gene_and_cell_outliers_batch_correction_starting_with_cells_X_EOL.py     #             
#                                                                                     #
####################################################################################### 
...
logfile_txt = "filter_gene_and_cell_outliers_batch_correction_starting_with_cells_X_EOL _seq_" + str ( sequence_out ) + ".txt"
...
print (  '\n\n len ( list_cells_X_Euclidean_OL ): ', len ( list_cells_X_Euclidean_OL ) , file=logfile ) 
...
#######  select batch counts for cells retained after excluding Euclidean outliers

dict_df_counts_X_EOL = {}
dict_df_cell_samples_X_EOL = {}
...
for batch in batches_list:
  ...
  dict_df_counts_X_EOL[ batch ] = df_counts_X_Euclidean_OL
  ...
  df_cell_samples_X_EOL = df_cell_samples_batch.loc [ list_cells_in_X_Euclidean_OL ]    
  print (  '\n\n df_cell_samples_X_EOL \n', df_cell_samples_X_EOL , file=logfile )  
  
  dict_df_cell_samples_X_EOL[ batch ] = df_cell_samples_X_EOL  
...
cell_outliers_dict =  identify_cell_outliers_batch_correction( logfile, dict_df_counts_X_EOL, dict_df_cell_samples_X_EOL, df_SSQ_PR_all_and_samples ) 
...
for batch in batches_list:
  ...
  df_counts_in = dict_df_counts_X_EOL[ batch ]
  print (  '\n\n df_counts_in \n', df_counts_in , file=logfile ) 
...
gene_outliers_dict = identify_gene_outliers_batch_correction ( logfile, dict_df_counts_X_cell_OL, dict_df_cell_samples_X_EOL )
...
print ( '\n\n program  filter_gene_and_cell_outliers_batch_correction_starting_with_cells_X_EOL.py  elapsed time (seconds): ',  f"{ elapsed:.1f}" , file=logfile )
