### after running, the input 
### dict_Sg_dict_pkl =  "dict_of_dicts_Sg_stats_and_samples_exclude_gene_and_cell_outliers_csc_batch_correction.pkl"
### must be moved to the save folder "initial count filtering" so as not to be clobbered by the next program in the pipeline:
###  Sg_stats_and_samples_exclude_gene_and_cell_outliers_csc_batch_correction_iteration.py 
### which reverts to dsns without reference to 'iteration' 

###################################################################### 
#                                                                    #
#  exclude_gene_and_cell_outliers_csc_batch_correction_iteration.py  #             
#                                                                    #
###################################################################### 
...
logfile_txt = "exclude_gene_and_cell_outliers_csc_batch_correction_iteration_1.txt"
dict_output_dict_pkl = "dict_of_dicts_exclude_gene_and_cell_outliers_csc_batch_correction_iteration_1.pkl" 
dict_counts_out_pkl = "dict_counts_exclude_gene_and_cell_outliers_csc_batch_correction_iteration_1.pkl" 

dict_Sg_dict_pkl =  "dict_of_dicts_Sg_stats_and_samples_exclude_gene_and_cell_outliers_csc_batch_correction.pkl"
dict_counts_in_pkl = "dict_counts_exclude_gene_and_cell_outliers_csc_batch_correction.pkl"
...
print ( '\n\n program  exclude_gene_and_cell_outliers_csc_batch_correction_iteration.py  elapsed time (seconds): ', \
f"{ elapsed:.1f}" , file=logfile )
