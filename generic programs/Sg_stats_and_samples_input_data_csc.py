...
#############################################
#                                           #       
#   Sg_stats_and_samples_input_data_csc.py  #
#                                           #   
#############################################
...
logfile_txt = "Sg_stats_and_samples_input_data_csc.txt"
Sg_dict_pkl =  "dict_Sg_stats_and_samples_input_data_csc.pkl"
counts_out_pkl = "counts_out_Sg_stats_input_csc.pkl"
...
####  non-zero rows (actually rows with fewer than nz_min nonzero cells) are removed, along with any remaining (newly created) all-zero cells
...
print ( '\n\n program  Sg_stats_and_samples_input_data_csc.py  elapsed time (seconds): ',  f"{ elapsed:.1f}" , file=logfile )
