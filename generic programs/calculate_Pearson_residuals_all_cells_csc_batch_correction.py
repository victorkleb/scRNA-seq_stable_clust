...
###################################################################
#                                                                 #       
#   calculate_Pearson_residuals_all_cells_csc_batch_correction.py #
#                                                                 #   
###################################################################
...
logfile_txt = "calculate_Pearson_residuals_all_cells_csc_batch_correction.txt"
...
df_HV_genes_pkl = "genes_HV_in_all_samples_csc_batch_correction.pkl"
...
print ( '\n\n program  calculate_Pearson_residuals_all_cells_csc_batch_correction.py  elapsed time (seconds): ',  f"{ elapsed:.1f}" , file=logfile )
