...
#### 2025 04 03 use Sg instead of Mg to caclulate IR - not worth the trouble to deal with 2nd order effect (variaton of sample size)
 
######################################################################################
#                                                                                    #       
#  evaluate_impact_of_filtering_counts_csc.py                                        #
#                                                                                    #   
######################################################################################
...
Sg_dict_input_pkl =  "dict_Sg_stats_and_samples_input_data_csc.pkl"
Sg_dict_filtered_pkl =  "dict_Sg_stats_and_samples_filtered_counts_csc.pkl"
...
Sg_dict_filtered_dsn = data_path / Sg_dict_filtered_pkl
...
Sg_input_dict = pickle.load( f )            
f.close()       

f = open( Sg_dict_filtered_dsn, 'rb' )    
Sg_filtered_dict = pickle.load( f )            
f.close()       




df_cell_samples_input = Sg_input_dict['df_cell_samples']
print (  '\n\n df_cell_samples_input \n', df_cell_samples_input , file=logfile )
n_cells_input = len ( df_cell_samples_input )

df_SSQ_PR_samples_input = Sg_input_dict['df_SSQ_PR_all_and_samples'].drop ( columns=['nz_cells', 'S_g'] )
print (  '\n\n df_SSQ_PR_samples_input \n', df_SSQ_PR_samples_input , file=logfile )

df_MSSQ_PR_input = Sg_input_dict['df_SSQ_PR_all_and_samples'][['nz_cells', 'S_g']]
df_MSSQ_PR_input.insert ( 0, 'M_g', df_MSSQ_PR_input['S_g'] / n_cells_input )
print (  '\n\n df_MSSQ_PR_input \n', df_MSSQ_PR_input , file=logfile )
...
df_stats_input = pd.concat ( [ df_MSSQ_PR_input[['M_g', 'nz_cells']], df_IR_input[['instabilty_ratio']] ], axis=1 )
print (  '\n\n df_stats_input \n', df_stats_input , file=logfile )
print (  '\n\n df_stats_input.describe \n', df_stats_input.describe( percentiles=pctl_list ) , file=logfile )

pdline( logfile )
 


df_cell_samples_filtered = Sg_filtered_dict['df_cell_samples']
print (  '\n\n df_cell_samples_filtered \n', df_cell_samples_filtered , file=logfile )
n_cells_filtered = len ( df_cell_samples_filtered )

df_SSQ_PR_samples_filtered = Sg_filtered_dict['df_SSQ_PR_all_and_samples'].drop ( columns=['nz_cells', 'S_g'] )
print (  '\n\n df_SSQ_PR_samples_filtered \n', df_SSQ_PR_samples_filtered , file=logfile )

df_MSSQ_PR_filtered = Sg_filtered_dict['df_SSQ_PR_all_and_samples'][['nz_cells', 'S_g']]
df_MSSQ_PR_filtered.insert ( 0, 'M_g', df_MSSQ_PR_filtered['S_g'] / n_cells_filtered )
print (  '\n\n df_MSSQ_PR_filtered \n', df_MSSQ_PR_filtered , file=logfile )
...
df_stats_filtered = pd.concat ( [ df_MSSQ_PR_filtered[['M_g', 'nz_cells']], df_IR_filtered[['instabilty_ratio']] ], axis=1 )
print (  '\n\n df_stats_filtered \n', df_stats_filtered , file=logfile )
print (  '\n\n df_stats_filtered.describe \n', df_stats_filtered.describe( percentiles=pctl_list ) , file=logfile )
