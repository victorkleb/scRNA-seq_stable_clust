### after running, must verify that the input 
### Sg_dict_pkl =  "dict_Sg_stats_and_samples_filtered_counts_csc.pkl"
### has been copied to the save folder "initial count filtering" so as not to be clobbered by the next program in the pipeline:
###  Sg_stats_and_samples_exclude_gene_and_cell_outliers_csc_iteration.py 
### which reverts to dsns without reference to 'iteration' 

###################################################################### 
#                                                                    #
#  exclude_gene_and_cell_outliers_csc_iteration.py                   #             
#                                                                    #
###################################################################### 
...
logfile_txt = "exclude_gene_and_cell_outliers_csc_iteration_1.txt"
dict_outputs_pkl = "dict_exclude_gene_and_cell_outliers_csc_iteration_1.pkl" 
counts_out_pkl = "counts_exclude_gene_and_cell_outliers_csc_iteration_1.pkl" 


counts_in_pkl = "counts_exclude_gene_and_cell_outliers_csc.pkl"
Sg_dict_pkl =  "dict_Sg_stats_and_samples_filtered_counts_csc.pkl"
...
print ( '\n\n program  exclude_gene_and_cell_outliers_csc_iteration.py  elapsed time (seconds): ',  f"{ elapsed:.1f}" , file=logfile )
