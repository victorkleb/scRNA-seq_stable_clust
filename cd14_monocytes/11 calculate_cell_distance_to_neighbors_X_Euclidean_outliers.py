...
############################################################################################## 
#                                                                                            #        
#   calculate_cell_distance_to_neighbors_X_Euclidean_outliers.py                             #
#                                                                                            #   
##############################################################################################
...
in_name = "exclude_Euclidean_outliers_seq_" + str ( sequence ) 

out_name = "calculate_cell_distance_to_neighbors_X_Euclidean_outliers_seq_" + str ( sequence ) 


logfile_txt = out_name + ".txt"
df_distance_summary_pkl = "df_" + out_name + ".pkl"

df_input_pkl = "df_" + in_name + ".pkl"
...
#### pickle input
df_input_dsn = data_path / df_input_pkl
...
df_S_Vt_X_outliers = pd.read_pickle ( df_input_dsn )
...
cell_list = df_S_Vt_X_outliers.columns.values.tolist()  
...
arr_input_tr = np.transpose( df_S_Vt_X_outliers.values )
...
for cell in cell_list:
  arr_cell = df_S_Vt_X_outliers[cell].values  [ np.newaxis, : ]
...
print ( '\n\n program  calculate_cell_distance_to_neighbors_X_Euclidean_outliers.py  elapsed time (seconds): ',  f"{ elapsed:.1f}" , file=logfile )
